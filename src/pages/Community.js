...
const Community = () => {
  return (
    <>
      {/* community section  */}
      <div className="mt-14 flex-col scrollbar-hide px-3 sm:px-6 max-w-[1240px] mx-auto overflow-y-auto">
        ...
        <div className=" mt-16 flex lg:flex-row items-center justify-center flex-col  ">
          <div className="  ">
            <div className="  ">
