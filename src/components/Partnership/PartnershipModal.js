                ...
                <div className='w-full px-3 pb-3 mx-auto h-fit flex flex-row-reverse'>
                    ...
                    <div className='w-full md:w-1/2 px-2'>
                        ...
                        <div className='md:mr-2'>
                            <form className='mt-4 '>
                                <label for="name" className='block text-[#F5F5F5]'>Name</label>
                                <input 
                                    id="name"
                                    name='username'
                                    type='text'
                                ...
                                <label for="organ" className='block text-[#F5F5F5]'>Organization</label>
                                <input 
                                    id="organ"
                                    name='organization'
                                    type='text'
                                ...
                                <label for="email" className='block text-[#F5F5F5]'>Email address</label>
                                <input 
                                    id="email"
                                    name='email'
                                    type='email'
                                ...
                                />
                                <label for="message" className='block text-[#F5F5F5]'>Email address</label>
                                <textarea
                                    id='message'
                                    name='message'
