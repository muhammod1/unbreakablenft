...
const Footer = () => {
  return (
    <motion.div
      ...
      className="pb-8  mt-24 px-3 sm:px-6 max-w-[1240px] mx-auto  flex flex-col items-center"
    >
      <div className="flex gap-5 justify-between flex-wrap md:flex-nowrap flex-col md:flex-row  w-full">
        <div className="w-full mb-8 flex  flex-col md:w-1/2">
          <div>
            <div>
              <h3 className="text-yellow font-audio">
                Follow us on social media
              </h3>
            </div>
            <p className="text-sm text-[#737373]">
              <span className="block">
                Keep up with all our activities and join other
              </span>{" "}
              Unbrokens around the world!
            </p>
