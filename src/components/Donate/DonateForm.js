            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='flex mt-10 justify-between p-5 border border-[#171717] rounded-lg'>
                    <div className='w-[50%]'>
                        ...
                        <select id="coins"  className="my-2 w-fit bg-yellow text-[black] text-bold text-[20px] rounded-lg p-2.5">
                        ...
                        <p className='mt-9 block text-[12px] text-[#737373]'>
                            Approx:
                        </p>
                    </div>
            ...
            <div className='w-[400px] p-5 border border-[#171717] rounded-lg'>
                ...
                <div className='flex justify-between '>
                    <div className=''>
                        ...
                        <p className='mt-3 block text-[14px] text-[#737373]'>email address</p>
                        <p className='mt-3 block text-[14px] text-[#737373]'>Your donation</p>
                    </div>
                    <div className=''>
                        <p className=' mt-3 text-[14px] text-end text-[#F5F5F5]'>Michael James</p>
                        <p className=' mt-3 text-[14px] text-end text-[#F5F5F5]'>michaeljames@gmail.com</p>
                        <p className=' mt-3 text-[14px] text-end text-[#F5F5F5]'>NGN 200,000</p>
                    </div>
                </div>
            </div>
        </div>
